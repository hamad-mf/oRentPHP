...
| 15 | Real-time online/offline status tracking for staff monitor: Admin shows online when logged in; Staff shows online when logged in AND punched in, offline when logged out OR punched out | `auth/login.php`, `auth/logout.php`, `attendance/punch.php`, `staff_monitor/index.php`, `migrations/releases/2026-04-09_user_session_tracking.sql`, `PRODUCTION_DB_STEPS.md` | Yes |
