...
$codex = [
    ...
    'vehicles' => ['id', 'brand', 'model', 'year', 'license_plate', 'color', 'vin', 'status', 'maintenance_started_at', 'maintenance_expected_return', 'maintenance_workshop_name', 'parts_due_notes', 'daily_rate', 'monthly_rate', 'rate_1day', 'rate_7day', 'rate_15day', 'rate_30day', 'image_url', 'created_at', 'updated_at'],
