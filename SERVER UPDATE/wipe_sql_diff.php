...
$codex = [
    ...
    'ledger_entries' => ['id', 'txn_type', 'category', 'description', 'amount', 'payment_mode', 'bank_account_id', 'source_type', 'source_id', 'source_event', 'idempotency_key', 'posted_at', 'created_by', 'created_at'],
    ...
    'vehicles' => ['id', 'brand', 'model', 'year', 'license_plate', 'color', 'vin', 'status', 'maintenance_started_at', 'maintenance_expected_return', 'maintenance_workshop_name', 'daily_rate', 'monthly_rate', 'rate_1day', 'rate_7day', 'rate_15day', 'rate_30day', 'image_url', 'created_at', 'updated_at'],
