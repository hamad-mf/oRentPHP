...
| 13 | Client create now requires address and proof document | `clients/create.php`, `UPDATE_SESSION_RULES.md` | No |
| 14 | Vehicle catalog branding updates and single-vehicle share links now auto-open the vehicle modal | `vehicles/catalog.php`, `UPDATE_SESSION_RULES.md` | No |
| 15 | Pollution certificate expiry date added on vehicles create/edit and shown on details | `vehicles/create.php`, `vehicles/edit.php`, `vehicles/show.php`, `migrations/releases/2026-03-14_vehicle_pollution_expiry_date.sql`, `PRODUCTION_DB_STEPS.md`, `UPDATE_SESSION_RULES.md` | Yes |
| 16 | Vehicle storage locations for second key and original documents added to create/edit/details | `vehicles/create.php`, `vehicles/edit.php`, `vehicles/show.php`, `migrations/releases/2026-03-14_vehicle_storage_locations.sql`, `PRODUCTION_DB_STEPS.md`, `UPDATE_SESSION_RULES.md` | Yes |
| 17 | Vehicle details page now allows inline editing of storage locations | `vehicles/show.php`, `UPDATE_SESSION_RULES.md` | No |
| 18 | Notifications settings tab added to control in-app notification generation | `settings/notifications.php`, `includes/notifications.php`, `settings/general.php`, `settings/damage_costs.php`, `settings/lead_sources.php`, `settings/expense_categories.php`, `settings/staff_permissions.php`, `settings/attendance.php`, `UPDATE_SESSION_RULES.md` | No |
